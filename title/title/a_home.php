...
<html lang="en" data-bs-theme="auto">
    ...
    <body>
        ...
        <?php
            ...
            $query = "SELECT name FROM tbl_admin WHERE id = $aid";
                ...
                <?php
                    ...
                    ?>
                            <tr>
                                ...
                                <td><button class="btn btn-outline-danger btn-sm" onclick="window.location.href='process_adelete.php?id=<?php echo $pid; ?>'">Delete</button></td>
