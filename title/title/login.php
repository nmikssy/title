...
<html lang="en" data-bs-theme="auto">
    ...
    <body class="d-flex align-items-center py-4 bg-body-tertiary">
        ...
        <main class="form-signin w-100 m-auto">
            <form id="form_login">
                <a href="index.php"><img style="display: block; margin: 0 auto;" class="mb-4" src="../title/title-img/pri-logo.png" alt="Title" width="57" height="57"></a>
                <h1 style="text-align:center;" class="h3 mb-3 fw-normal">Welcome Back!</h1>
                ...
                <p style="text-align:center;">Don't have an account? <a href="index.php">Sign Up Here.</a></p>
            </form>
        </main>
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (response_data.type === 'success') {
                                ...
                                alert("Error! " + response_data.text);
                            }
                        }
                    });
                });
