            ...
            <div class="container">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="a_viewapplications.php">View Applicants</a>
                        </li>
                    </ul>
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td><button class="btn btn-outline-success btn-sm" onclick="window.location.href='process_acceptapplication.php?id=<?php echo $aid; ?>'">Accept</button></td>
                            <td><button class="btn btn-outline-danger btn-sm" onclick="window.location.href='process_rejectapplication.php?id=<?php echo $aid; ?>'">Reject</button></td>
                        </tr>
                <?php
                    }
                } else {
